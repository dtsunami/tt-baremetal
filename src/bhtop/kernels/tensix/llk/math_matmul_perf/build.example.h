...
constexpr ckernel::MathFidelity MATH_FIDELITY = ckernel::MathFidelity::LoFi;
...
struct RuntimeParams
{
    ...
    std::uint32_t PARTIAL_FACE_A;
    std::uint32_t PARTIAL_FACE_B;
    std::uint32_t PARTIAL_FACE_MATH;
    std::uint32_t PARTIAL_FACE_PACK;
    std::uint32_t RT_DIM;
    std::uint32_t TILE_SIZE_PACK;
    std::uint32_t TILE_SIZE_UNPACK_A;
    std::uint32_t TILE_SIZE_UNPACK_B;
    std::uint32_t UNPACK_TRANSPOSE_FACES;
    Operand buffer_A;
    Operand buffer_B;
