"""Cross-check the scalar C (proj_h_hosttest.c) against the numpy golden (gap1_proj_golden.py).
...
subprocess.run(["gcc","-O2","-I../src/bhtop/kernels/x280/het","-o","proj_h_hosttest","proj_h_hosttest.c","-lm"], check=True, cwd=".")
out = subprocess.run(["./proj_h_hosttest"], input=inp, capture_output=True, text=True, check=True).stdout
